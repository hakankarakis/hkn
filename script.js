// Soru ve cevapları bir dizi içinde tanımlayalım
var sorular = [
...
var soruIndex = 0; // Başlangıçta ilk soruya odaklanalım

// Gerekli elementleri seçelim
var soruCevapDiv = document.getElementById("soru-cevap");
var oncekiBtn = document.getElementById("onceki-btn");
var soruBtn = document.getElementById("soru-btn");
var sonrakiBtn = document.getElementById("sonraki-btn");

// Soru ve cevapları görüntülemek için bir işlev oluşturalım
function gosterSoruCevap(index) {
  var soru = sorular[index].soru;
  var cevap = sorular[index].cevap;
  
  // Soruyu ve cevabı ekrana yazdıralım
  soruCevapDiv.innerHTML = "<h2>Soru:</h2><p>" + soru + "</p><h2>Cevap:</h2><p>" + cevap + "</p>";
}

// İlk soruyu gösterelim
gosterSoruCevap(soruIndex);

// Önceki soruya geçmek için bir olay dinleyici ekleyelim
...
// Sonraki soruya geçmek için bir olay dinleyici ekleyelim
...
// Soruyu göstermek için bir olay dinleyici ekleyelim
soruBtn.addEventListener("click", function() {
  gosterSoruCevap(soruIndex);
});
